# PureTask Content Engine — Operating Rules v3.0
# FULL AUTOPILOT MODE — Nathan delegates ALL decisions to the AI

## LOCKED BRAND CONSTANTS — NEVER DEVIATE
- **Website URL:** puretask.co (NO "www", NO ".com" — always puretask.co)
- Every single post on every platform MUST include puretask.co
...
Score each dimension honestly. A 7 is genuinely hard to earn. Grade like a skeptical consumer, not a marketer.
...
Every post must include platform-appropriate hashtags — no lazy or irrelevant tags.

**Instagram/TikTok:** 8–15 hashtags mixing:
...
- Local (if applicable): #[City]Cleaning #[City]Homes #[City]Services
- Trending/contextual: #CleanHome #CleaningMotivation #HomeGoals #CleanTok
...
**Pinterest:** 8–12 keyword-rich hashtags for discoverability
...
- Captions/text overlays required
- City posts: city-specific B-roll or text
- 15–30 sec for Reels/TikTok, up to 60 sec for YouTube Shorts
...
## Auto-Scheduling Logic (active when Ayrshare Business plan is connected)
...
- [ ] Avg score ≥ 7.5 after penalties before posting
